...
const article = {
    id: '8500',
    title: 'LỄ PHÁT ĐỘNG THI ĐUA CHÀO MỪNG ĐẠI HỘI ĐẢNG BỘ TỔNG CÔNG TY CP DỆT MAY HÒA THỌ LẦN THỨ XVI, NHIỆM KỲ 2025 - 2030',
    date: '09/06/2025',
    content: [
        '<p style="text-align: justify;"><span style="white-space: pre;">	</span>Hướng tới Đại hội đại biểu Đảng bộ Tổng Công ty Cổ phần Dệt May Hòa Thọ lần thứ XVI, Nhiệm kỳ 2025 – 2030, sáng ngày 9/6/2025, tại Hội trường Tổng Công ty, Đảng ủy Tổng Công ty đã trang trọng tổ chức "Lễ phát động thi đua chào mừng Đại hội Đảng bộ Tổng Công ty".</p>',
        '<p style="text-align: center;"><img alt="" src="/images/tin-tuc/l1.jpg" /></p>',
        '<p style="text-align: center;"><em>Tinh thần quyết tâm thi đua đạt thành tích cao của tập thể<br />Đảng bộ Tổng Công ty Cổ phần Dệt May Hòa Thọ</em></p>',
        ...
        '<div style="text-align: justify;"><span style="white-space: pre;">	</span>Phát biểu khai mạc buổi lễ, đồng chí Nguyễn Thanh Sơn - Phó Bí thư Đảng ủy, Chủ tịch Công đoàn Tổng Công ty khẳng định: "Đợt phát động thi đua là dịp để toàn Đảng bộ và người lao động Hòa Thọ nhìn lại chặng đường đã qua, phát huy truyền thống vẻ vang, từ đó tiếp tục nỗ lực, phấn đấu vươn lên, xây dựng Tổng Công ty phát triển vững mạnh trong giai đoạn mới".</div>',
        ...
        '<div style="text-align: justify;"><span style="white-space: pre;">	</span>Phong trào thi đua được phát động sâu rộng trong toàn Đảng bộ với phương châm: "Đoàn kết - Dân chủ - Kỷ cương - Sáng tạo - Phát triển". Phát biểu phát động thi đua tại buổi lễ, đồng chí Nguyễn Ngọc Bình - Ủy viên Ban Thường vụ Đảng ủy, Tổng Giám đốc Tổng Công ty nhấn mạnh 04 mục tiêu trong đợt thi đua này gồm:<br /><span style="white-space: pre;">	</span>1 - Thi đua lao động sản xuất hoàn thành vượt mức kế hoạch sản xuất - kinh doanh, đảm bảo chất lượng, tiến độ đơn hàng, giữ vững uy tín với khách hàng.<br /><span style="white-space: pre;">	</span>2 - Thực hiện tốt công tác an toàn lao động, phòng chống cháy nổ, an toàn vệ sinh thực phẩm, xây dựng môi trường làm việc an toàn - sạch đẹp - kỷ cương. Thực hiện chăm lo tốt hơn đời sống người lao động.<br /><span style="white-space: pre;">	</span>3 - Phát huy sáng kiến, cải tiến kỹ thuật, tiết kiệm nguyên vật liệu, giảm chi phí sản xuất, nâng cao hiệu quả.<br /><span style="white-space: pre;">	</span>4 - Xây dựng hình ảnh người lao động Hòa Thọ chuyên nghiệp, trách nhiệm, đoàn kết, đổi mới, sáng tạo, góp phần xây dựng Tổng Công ty phát triển bền vững.<br /><span style="white-space: pre;">	</span>Tại buổi lễ, các đơn vị trong toàn hệ thống Hòa Thọ đã cam kết thi đua bằng những chỉ tiêu cụ thể, gắn liền với đặc thù sản xuất kinh doanh của từng đơn vị, thể hiện rõ quyết tâm chính trị cao, hành động thiết thực hướng tới thành công của Đại hội Đảng bộ Tổng Công ty lần thứ XVI.</div>',
...
//     {
//         id: '7493',
//         title: 'Tổng Công ty CP Dệt May Hòa Thọ: Đào tạo, bồi dưỡng, thu hút nhân tài, tạo nguồn nhân lực chất lượng cao',
//         date: '26/04/2025',
//         content:
//             'Sáng 26/4, Tổng Công ty Cổ phần Dệt May Hòa Thọ (Hòa Thọ) tổ chức Đại hội đồng cổ đông thường niên năm 2025. Dự Đại hội có ông Lê Tiến Trường – Chủ tịch HĐQT Tập đoàn Dệt May Việt Nam (Vinatex), ông Nguyễn Đức Trị – Phó Tổng Giám đốc Tập đoàn, Thành viên HĐQT Tổng Công ty CP Dệt May Hoà Thọ. Đại hội có sự tham dự của 135 cổ đông và người được uỷ quyền đại diện cho 29.874.048 cổ phần, chiếm 82,98% tổng số cổ phần Tổng Công ty.',
...
//         date: '16/04/2025',
//         content:
//             'Sáng ngày 15/4/2025, Tổng Công ty Cổ phần Dệt May Hòa Thọ tổ chức Hội nghị Sơ kết hoạt động sản xuất kinh doanh Quý I, triển khai nhiệm vụ, kế hoạch Quý II năm 2025. Ông Nguyễn Văn Hải - Bí thư Đảng ủy, Chủ tịch HĐQT chủ trì và điều hành hội nghị.',
...
//     {
//         id: '7488',
//         title: 'Quý I/2025 – Khởi đầu bứt phá của Hòa Thọ',
//         date: '16/04/2025',
//         content:
//             'Hành trình ba tháng đầu năm đã ghi dấu nhiều nỗ lực và thành quả đáng tự hào trong toàn hệ thống Hòa Thọ.',
